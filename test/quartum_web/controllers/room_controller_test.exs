defmodule QuartumWeb.RoomControllerTest do
  use QuartumWeb.ConnCase

  alias Quartum.Reservations

  @create_attrs %{air_conditioner: true, bathrooms: 42, capacity: 42, double_beds: 42, microwave: true, minibar: true, single_beds: 42, size: "some size", tv: true}
